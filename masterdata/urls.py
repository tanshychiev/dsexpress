...
from . import views
from .views_portal_report import seller_portal_report
...
urlpatterns = [
    ...
    path(
        "sellers/<int:pk>/portal-report/",
        seller_portal_report,
        name="seller_portal_report",
    ),
    path("sellers/<int:pk>/delete/", views.seller_delete, name="seller_delete"),
    path(
        "sellers/<int:pk>/toggle-active/",
        views.seller_toggle_active,
        name="seller_toggle_active",
    ),
    ...
    path(
        "shippers/<int:pk>/toggle-active/",
        views.shipper_toggle_active,
        name="shipper_toggle_active",
    ),
